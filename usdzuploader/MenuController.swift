...
class MenuController: UITabBarController {
    override func viewDidLoad() {
        ...
        let sceneDirectoryViewController = SceneDirectoryViewController()
        ...
        let whiteScreenTabBarItem = UITabBarItem(title: "Model Directory", image: UIImage(systemName: "square.fill"), tag: 1)
        ...
        let sceneDirectoryTabBarItem = UITabBarItem(title: "Scene Directory", image: UIImage(systemName: "folder.fill"), tag: 2)
        sceneDirectoryViewController.tabBarItem = sceneDirectoryTabBarItem

        // Add view controllers to the tab bar
        self.viewControllers = [arViewController, whiteScreenViewController, sceneDirectoryViewController]
        ...
        sceneDirectoryViewController.edgesForExtendedLayout = [.top, .bottom]
    }
